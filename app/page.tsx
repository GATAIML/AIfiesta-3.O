          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border-4 border-black rounded-lg bg-white shadow-[6px_6px_0px_black] p-6 text-left">
              ...
              <p className="text-lg text-gray-700 mb-4">
                This competition challenges participants to design and develop
                an intelligent chatbot within a limited time frame. Teams will
                build their chatbot during a 5-hour lab session, after which
              ...
              <div className="bg-slate-100 border-2 border-black rounded-md p-4">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>👥 Team Participation Only (1-3 Members per Team)</li>
            ...
            <div className="border-4 border-black rounded-lg bg-white shadow-[6px_6px_0px_black] p-6 text-left">
              ...
              <p className="text-lg text-gray-700 mb-4">
                AIdeathon is an innovation challenge where teams conceptualize
                and present AI-driven solutions to real-world problems.
                Participants will pitch their ideas, receive feedback, and
                refine their solutions for the final round.
              </p>
              <p className="text-lg text-gray-700 mb-4 font-semibold">
                Please read the rules carefully before registering.
              </p>
